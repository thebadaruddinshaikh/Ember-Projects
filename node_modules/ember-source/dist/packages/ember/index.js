...
deprecate('Internet Explorer 11 will no longer be supported in the next major version of Ember. For details on the new browser support policy, see the official documentation: http://emberjs.com/browser-support', !isIE, {
...
if (ENV.EXTEND_PROTOTYPES.String) {
  String.prototype.htmlSafe = function () {
    deprecate(`String prototype extensions are deprecated. Please import htmlSafe from '@ember/template' instead.`, false, {
