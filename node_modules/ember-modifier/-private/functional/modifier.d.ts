 ...
 */
export default function modifier<E extends Element = Element, P extends ModifierArgs['positional'] = ModifierArgs['positional'], N extends ModifierArgs['named'] = ModifierArgs['named']>(fn: FunctionalModifier<P, N, E>): unknown;
