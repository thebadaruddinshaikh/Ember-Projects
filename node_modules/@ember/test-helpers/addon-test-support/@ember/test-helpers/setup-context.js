...
import { getWarningsForContext, getWarningsDuringCallbackForContext } from './-internal/warnings'; // This handler exists to provide the underlying data to enable the following methods:
// * getDeprecations()
...
export function getWarningsDuringCallback(callback) {
  const context = getContext();
