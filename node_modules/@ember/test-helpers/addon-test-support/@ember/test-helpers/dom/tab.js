...
function triggerResponderChange(backwards, unRestrainTabIndex) {
  ...
  return Promise.resolve().then(() => runHooks('tab', 'start', debugData)).then(() => getActiveElement(ownerDocument)).then(activeElement => {
    return runHooks('tab', 'targetFound', activeElement).then(() => activeElement);
  }).then(activeElement => {
